...
public class CourseService : ICoursesService
{
    ...
    public void AddCourse(Course course)
    {
        ...
        context.GetConnection().Execute(cmd,course);
    ...
    public List<Course> GetAllCourses()
    {
        ...
        List<Course> courses  = context.GetConnection().Query<Course>(cmd).ToList();
        return courses;
        }
        catch (NpgsqlException e)
        {
    ...
    public Course GetCourseById(int id)
    {
        ...
        var course  = context.GetConnection().Query<Course>(cmd,new {id = id});
